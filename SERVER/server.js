...
const allowedOrigins = [
    'https://backend-yhda.onrender.com',
...
app.use(cors({
    origin: function (origin, callback) {
        if (!origin) {
            console.log('✅ CORS allowed: No origin (non-browser request)');
...
const adminPath1 = path.join(__dirname, 'admin');
const adminPath2 = path.join(__dirname, '../admin');

// Check if admin folder exists
const fs = require('fs');
let adminPath = adminPath1;
if (!fs.existsSync(adminPath1)) {
    console.log('⚠️ Admin folder not found at:', adminPath1);
    console.log('📁 Trying alternative path:', adminPath2);
    adminPath = adminPath2;
}
...
if (fs.existsSync(adminPath)) {
    ...
    console.warn('⚠️ Admin folder not found! Create admin folder with index.html');
    ...
    app.get('/admin', (req, res) => {
        res.send(`
            ...
            <body style="font-family: Arial; text-align: center; padding: 50px; background: #0d0d0d; color: white;">
                ...
                <p>Admin folder not found. Please create <code>admin/index.html</code></p>
                <p style="color: #666; font-size: 12px;">API URL: https://backend-yhda.onrender.com</p>
            </body>
            </html>
        `);
    });
...
app.listen(PORT, async () => {
    ...
    console.log(`🔗 Backend URL: https://backend-yhda.onrender.com`);
    console.log(`💚 Health: https://backend-yhda.onrender.com/health`);
    console.log(`🏠 Root: https://backend-yhda.onrender.com/`);
    console.log(`📚 API Docs: https://backend-yhda.onrender.com/api`);
    console.log(`🖥️ Admin Panel: https://backend-yhda.onrender.com/admin`);
    console.log('='.repeat(60));
    console.log('\n🔑 Admin Login:');
